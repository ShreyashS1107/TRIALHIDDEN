...
export interface ProjectSearchRecord {
  ...
  revised_cost_crore: number;
  cumulative_expenditure_crore: number;
  cost_escalation_crore: number;
  cost_variance_percent: number;
  has_revision: boolean;
  original_completion_date: string;
  revised_completion_date: string;
  physical_progress_percent: number;
  risk_band: 'LOW' | 'MEDIUM' | 'MODERATE' | 'HIGH' | 'VERY_HIGH' | 'NOT_ASSESSED';
  selected_integrated_risk: number | null;
  previous_risk: number | null;
  risk_trend: 'increasing' | 'stable' | 'decreasing';
  dominant_component: string;
  schedule_delay_risk: number | null;
  cost_overrun_risk: number | null;
  schedule_revision_risk: number | null;
  schedule_contribution: number | null;
  cost_contribution: number | null;
  schedule_revision_contribution: number | null;
  has_ml_telemetry: boolean;
...
export interface ProjectHistoricalRecord {
  report_month: string;
  original_cost_crore: number;
  revised_cost_crore: number;
  cumulative_expenditure_crore: number;
